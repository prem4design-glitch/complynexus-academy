    ...
    <div className="min-h-screen bg-(--bg-page) flex flex-col items-center justify-center p-6 lg:p-12">
      ...
      >
        <div className="flex flex-col w-full gap-(--gap-24)">
          <div className="bg-(--primary-10) border border-(--primary-50) rounded-(--radius-14) p-[15px] flex items-center gap-[16px] w-full">
            <div className="bg-(--primary-25) rounded-[4px] p-[8px] flex items-center justify-center shrink-0">
               <InstitutionIcon />
            </div>
            <div className="flex flex-col gap-[6px] items-start min-w-0">
              <p className="body-1 font-(--weight-medium) text-(--black)">Acme Corporation</p>
              <p className="body-2 text-(--black-75) truncate">We found your organization based on your email domain.</p>
            </div>
          </div>
          ...
          <div className="text-center">
            <Link to="/signin" className="body-2 text-(--primary) font-(--weight-regular) hover:underline">
